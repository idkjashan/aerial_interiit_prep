...
USER_HOME="/home/jashan"
PX4_DIR="${PX4_DIR:-$USER_HOME/PX4-Autopilot}"
WS_DIR="${WS_DIR:-$USER_HOME/aerial_interiit_prep}"
PX4_WS="${PX4_WS:-$USER_HOME/px4_ros_ws}"
...
export GZ_SIM_RESOURCE_PATH="$PX4_DIR/Tools/simulation/gz/models:$PX4_DIR/Tools/simulation/gz/worlds:$USER_HOME/training_pool/src/drdo_gz_worlds/models:$USER_HOME/training_pool/src/drdo_gz_worlds/worlds:${GZ_SIM_RESOURCE_PATH:-}"
